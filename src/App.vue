...
const token = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjozNCwicm9sZSI6ImN1c3RvbWVyIiwiaWF0IjoxNzI3NDE4Nzc4LCJleHAiOjE3NTYyMTg3NzgsImp0aSI6Ijk5ZmU3MGM2YmVkYzRmNDdiY2RlYTBjZWJkOTM2ODFmIiwidG9rZW5fdHlwZSI6ImFjY2VzcyJ9.ty9aJY6K4xNm9uNTj7hhmGfvcP4nXJUyCjVx_7gPNqY`;
const wsUrl = `ws://5.182.26.58:4321/ws/web?token=${token}`;
const wsService = ref<WebSocketService>(new WebSocketService(wsUrl));
